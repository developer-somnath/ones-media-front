...
@section('content')
        ...
        <div class="container">
            ...
            <div>
                ...
                <div class="product-filter">
                    ...
                    <div class="cate-list">
                        <ul>
                            ...
                            @endphp
                            <li><a href="{{ url('/show-by-year/' . $title) }}">Show All</a></li>
                ...
                <div class="home-pro-list">
                    <table class="w-100" id="yearDatatable">
                        <thead>
                            <th>image</th>
                            <th>Title</th>
                            <th>Year</th>
    ...
    <form action="{{ url('/show-by-year/' . $title) }}" method="GET" id="yearForm">
...
@push('scripts')
    ...
    <script>
        ...
        const loadData = () => {
            ...
            var dataTable = $('#yearDatatable').DataTable({
                {{--  dom: 'Bfrtip',  --}}
                processing: true,
                serverSide: false,
                autoWidth: false,
