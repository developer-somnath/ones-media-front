                ...
                @if (count($cartsCount) > 0)
                                        ...
                                        <tr>
                                            <td>
                                                <div class="list-p-title">
                                                    <a href="{{ url('show/details/' . $details['id']) }}">
                                                        <h3>{{ $details['name'] }}</h3>
                                                    </a>
                                                    <form action="" method="" id="customForm">
                                                        @csrf
                                                        <select class="type"
                                                            onchange=getPrice({{ $details['id'] }},this.value)>
                                                            <option data-id="{{ $details['id'] }}" value="1"
                                                                @if ($details['type'] == 1 || $details['type'] == '') selected @endif>
                                                                Instant Download
                                                            </option>
                                                            <option data-id="{{ $details['id'] }}" value="2"
                                            ...
                                            <td>
                                                <form class="userFrm" data-action="update-cart-quantity" method="post"
                    ...
                    <td>
                        <div class="list-p-btn">
                            ...
                            <button type="button" class="removeFromCart" data-id="{{ $details['id'] }}">Remove</button>
                        </div>
                    </td>
                    </tr>
                @endforeach
