...
<body>
    ...
    <div class="container">
        <div class="l-account-page">
            <h3>Welcome {{ Auth::user()->first_name . ' ' . Auth::user()->last_name }}!</h3>
            <div class="row">
                <div class="col-md-4">
                    <div class="my-acc-left">
                        <ul>
                            <li><a href="{{ url('my-account') }}"
                                    class="@if (Request::segment(1) == 'my-account') active @endif"><span><i
                                            class="fa-solid fa-user"></i></span>Account</a></li>
                            <li><a href="{{ url('order-history') }}"
                                    class="@if (Request::segment(1) == 'order-history' || Request::segment(1) == 'order-details') active @endif"><span><i
                                            class="fa-solid fa-list"></i></span>Order History</a></li>
                            <li><a href="{{ url('purchased-recordings') }}"
                                    class="@if (Request::segment(1) == 'purchased-recordings') active @endif"><span><i
                                            class="fa-solid fa-list"></i></span>Purchased-Recordings</a></li>
                            <li><a href="{{ url('my-wishlist') }}"
                                    class="@if (Request::segment(1) == 'my-wishlist') active @endif"><span><i
                                            class="fa-solid fa-heart"></i></span>Wishlist</a></li>
                            <li><a href="{{ url('change-password') }}"
                                    class="@if (Request::segment(1) == 'change-password') active @endif"><span><i
                                            class="fa-solid fa-lock"></i></span>Change Password</a></li>
                            <li><a href="{{ url('logout') }}"><span><i
                                            class="fa-solid fa-right-from-bracket"></i></span>Sign Out</a></li>
                        </ul>
                    </div>
                </div>
                @yield('content')
