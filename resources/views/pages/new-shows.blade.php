...
@section('content')
    ...
    <div class="main-part-home">
        <div class="container">
            ...
            <div>
                ...
                <div class="cate-list">
                    <ul>
                        ...
                        @endphp
                        <li><a href="{{ url('/new-shows') }}">Show All</a></li>
            ...
            <div class="home-pro-list">
                <table class="w-100" id="newShowsDatatable">
                    <thead>
                        <th>image</th>
                        <th>Title</th>
                        <th>Popularity</th>
    ...
    <form action="{{ url('/new-shows') }}" method="GET" id="newShowForm">
...
@push('scripts')
    ...
    <script>
        ...
        const loadData = () => {
            ...
            var dataTable = $('#newShowsDatatable').DataTable({
                {{--  dom: 'Bfrtip',  --}}
                processing: true,
                serverSide: false,
                autoWidth: false,
