...
@section('content')
    ...
    <div class="main-part-home">
        <div class="container">
            ...
            <div>
                <div class="page-title">
                    <h2>All {{ $title ? ucfirst($title) : '' }} Shows</h2>
                </div>
                <div class="product-filter">
                    ...
                    <div class="cate-list">
                        <ul>
                            ...
                            @endphp
                            <li><a href="{{ url('/show-by-category/' . $title) }}">Show All</a></li>
                ...
                <div class="home-pro-list">
                    <table class="w-100" id="categoryDatatable">
                        <thead>
                            <th>image</th>
                            <th>Title</th>
                            <th>Popularity</th>
    ...
    <form action="{{ url('/show-by-category/' . $title) }}" method="GET" id="categoryForm">
